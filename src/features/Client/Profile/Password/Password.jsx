...
const Password = () => {
  ...
  const handleChange = async (e) => {
    ...
    if (password === "" && rePassword === "" && oldPassword === "") {
      ...
      await userService._editPass(dispatch, data, currentUser?._id);
      naviage("/account");
    }
  };
  const handleImg1 = () => {
  ...
  return (
    <div classNameName="mb-[38rem]">
      <p classNameName="text-2xl font-semibold mb-6">Thiết lập mật khẩu</p>
              ...
              <div className="form-control">
                ...
                <div className="styles__StyledInput-sc-s5c7xj-5 hisWEc">
                  <input
                    ...
                    onClick={(e) => setInput0("")}
                  />
                  <img src={img0} alt="" onClick={() => handleImg0()} className="icon-right" />
                </div>
              </div>
            ) : (
              <></>
