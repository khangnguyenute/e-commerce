...
const Button = (
  { isLoading, children, className, disabled, color = "primary", size = "normal", ...anotherProps },
  ref,
) => {
  let colorClassNames = "";
  let sizeClassNames = "";
  ...
  switch (color) {
    case "light":
      ...
      break;
    case "blue":
      colorClassNames += "bg-blue-500 hover:bg-blue-700 text-white ring-gray-200 disabled:ring-gray-200";
      spinnerColorClassNames += "border-gray-400";
      break;
    case "orange":
